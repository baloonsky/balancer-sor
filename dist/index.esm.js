...
// PairType = 'token->token'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapExactTokenInForTokenOutBigInt(
    balanceIn,
    weightIn,
    balanceOut,
    weightOut,
...
// PairType = 'token->token'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapTokenInForExactTokenOutBigInt(
    balanceIn,
    weightIn,
    balanceOut,
    weightOut,
 ...
 * @returns BPT out.
 */
function _calcBptOutGivenExactTokensIn$1(
    balances,
    normalizedWeights,
    amountsIn,
    bptTotalSupply,
...
function _calcTokenOutGivenExactBptIn$1(
    balance,
    normalizedWeight,
    bptAmountIn,
    bptTotalSupply,
...
function _calcBptInGivenExactTokensOut$1(
    balances,
    normalizedWeights,
    amountsOut,
    bptTotalSupply,
...
var weightedMath = /*#__PURE__*/ Object.freeze({
    ...
    _spotPriceAfterSwapExactTokenInForTokenOutBigInt:
        _spotPriceAfterSwapExactTokenInForTokenOutBigInt,
    _spotPriceAfterSwapTokenInForExactTokenOutBigInt:
        _spotPriceAfterSwapTokenInForExactTokenOutBigInt,
...
function _poolDerivativesBPT$2(
    amp,
    balances,
    bptSupply,
    tokenIndexIn,
...
var stableMath = /*#__PURE__*/ Object.freeze({
    ...
    _spotPriceAfterSwapExactTokenInForTokenOut:
        _spotPriceAfterSwapExactTokenInForTokenOut$3,
    _spotPriceAfterSwapTokenInForExactTokenOut:
        _spotPriceAfterSwapTokenInForExactTokenOut$3,
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut:
        _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$4,
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut:
        _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$4,
    _spotPriceAfterSwapTokenInForExactBPTOut:
        _spotPriceAfterSwapTokenInForExactBPTOut$2,
});
...
function _calculateInvariant$2(amp, balances, roundUp) {
    /**********************************************************************************************
      // invariant                                                                                 //
      // D = invariant                                                  D^(n+1)                    //
...
function _calcOutGivenIn$2(
    ...
    const invariant = _calculateInvariant$2(amp, balances, true);
...
function _calcBptOutGivenExactTokensIn(
    ...
    const currentInvariant = _calculateInvariant$2(amp, balances, true);
    const newInvariant = _calculateInvariant$2(amp, newBalances, false);
...
// PairType = 'token->token'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapExactTokenInForTokenOut$2(
    amp,
    balances,
    tokenIndexIn,
    tokenIndexOut,
...
// PairType = 'token->token'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapTokenInForExactTokenOut$2(
    amp,
    balances,
    tokenIndexIn,
    tokenIndexOut,
...
// PairType = 'token->BPT'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapExactTokenInForBPTOut$1(
    amp,
    balances,
    tokenIndexIn,
    bptTotalSupply,
...
// PairType = 'token->BPT'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapTokenInForExactBPTOut$1(
    amp,
    balances,
    tokenIndexIn,
    bptTotalSupply,
...
// PairType = 'BPT->token'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapExactBPTInForTokenOut$1(
    amp,
    balances,
    tokenIndexOut,
    bptTotalSupply,
    ...
    const ans = _poolDerivativesBPT$1(
        amp,
        balances,
        bptTotalSupplyAfter,
        tokenIndexOut
...
// PairType = 'BPT->token'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapBPTInForExactTokenOut$1(
    amp,
    balances,
    tokenIndexOut,
    bptTotalSupply,
...
function _poolDerivatives$1(
    ...
    const totalCoins = balances.length;
    const D = _calculateInvariant$2(amp, balances, true);
    let S = BigInt(0);
    for (let i = 0; i < totalCoins; i++) {
        if (i != tokenIndexIn && i != tokenIndexOut) {
            S += balances[i];
...
var stableMathBigInt = /*#__PURE__*/ Object.freeze({
    ...
    _spotPriceAfterSwapExactTokenInForTokenOut:
        _spotPriceAfterSwapExactTokenInForTokenOut$2,
    _spotPriceAfterSwapTokenInForExactTokenOut:
        _spotPriceAfterSwapTokenInForExactTokenOut$2,
    _spotPriceAfterSwapExactTokenInForBPTOut:
        _spotPriceAfterSwapExactTokenInForBPTOut$1,
    _spotPriceAfterSwapTokenInForExactBPTOut:
        _spotPriceAfterSwapTokenInForExactBPTOut$1,
    _spotPriceAfterSwapExactBPTInForTokenOut:
        _spotPriceAfterSwapExactBPTInForTokenOut$1,
    _spotPriceAfterSwapBPTInForExactTokenOut:
        _spotPriceAfterSwapBPTInForExactTokenOut$1,
...
class MetaStablePool {
    ...
    _exactTokenInForTokenOut(poolPairData, amount) {
        try {
            ...
            const amountConverted = amtWithFee
                ...
                .div(WeiPerEther);
            const returnAmt = _calcOutGivenIn$2(
                this.amp.toBigInt(),
                poolPairData.allBalancesScaled.map((balance) =>
                    balance.toBigInt()
                ),
    ...
    _tokenInForExactTokenOut(poolPairData, amount) {
        try {
            ...
            const returnAmount = _calcInGivenOut$2(
                this.amp.toBigInt(),
                poolPairData.allBalancesScaled.map((balance) =>
                    balance.toBigInt()
                ),
            ...
            const returnAmtWithFee = this.addSwapFeeAmount(
                BigNumber$1.from(returnAmountConverted),
                poolPairData.swapFee
            );
...
// PairType = 'main->BPT'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapBptOutPerMainIn(
    mainIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'main->BPT'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapMainInPerBptOut(
    bptOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'BPT->main'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapMainOutPerBptIn(
    bptIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'BPT->main'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapBptInPerMainOut(
    mainOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapMainInPerWrappedOut(
    wrappedOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapWrappedInPerMainOut(
    mainOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'main->wrapped'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapWrappedOutPerMainIn(
    mainIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'wrapped->main'
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapMainOutPerWrappedIn(
    wrappedIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapBptOutPerWrappedIn(
    wrappedIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// SwapType = 'swapExactIn'
function _spotPriceAfterSwapWrappedOutPerBptIn(
    bptIn,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'wrapped->BPT'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapWrappedInPerBptOut(
    bptOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
// PairType = 'BPT->wrapped'
// SwapType = 'swapExactOut'
function _spotPriceAfterSwapBptInPerWrappedOut(
    wrappedOut,
    mainBalance,
    wrappedBalance,
    bptSupply,
...
class PhantomStablePool {
    ...
    _derivativeSpotPriceAfterSwapExactTokenInForTokenOut(poolPairData, amount) {
        ...
        if (poolPairData.pairType === PairTypes.TokenToBpt) {
            ...
            result = _derivativeSpotPriceAfterSwapExactTokenInForTokenOut$2(
                amountConverted,
                poolPairData
            );
        }
    ...
    _derivativeSpotPriceAfterSwapTokenInForExactTokenOut(poolPairData, amount) {
        ...
        if (poolPairData.pairType === PairTypes.TokenToBpt) {
            ...
            result = _derivativeSpotPriceAfterSwapTokenInForExactTokenOut$2(
                amountConverted,
                poolPairData
            );
        }
...
parseFixed('0.3', 18);
parseFixed('0.3', 18);
const SQRT_1E_NEG_1$1 = BigNumber$1.from('316227766016837933');
const SQRT_1E_NEG_3$1 = BigNumber$1.from('31622776601683793');
const SQRT_1E_NEG_5$1 = BigNumber$1.from('3162277660168379');
const SQRT_1E_NEG_7$1 = BigNumber$1.from('316227766016837');
const SQRT_1E_NEG_9$1 = BigNumber$1.from('31622776601683');
const SQRT_1E_NEG_11$1 = BigNumber$1.from('3162277660168');
const SQRT_1E_NEG_13$1 = BigNumber$1.from('316227766016');
const SQRT_1E_NEG_15$1 = BigNumber$1.from('31622776601');
const SQRT_1E_NEG_17$1 = BigNumber$1.from('3162277660');
...
function _makeInitialGuess$1(input) {
    if (input.gte(WeiPerEther)) {
        return BigNumber$1.from(2)
            .pow(_intLog2Halved$1(input.div(WeiPerEther)))
            .mul(WeiPerEther);
    } else {
        if (input.lte('10')) {
...
function _normalizeBalances$1(balances, decimalsIn, decimalsOut) {
    ...
    return balances.map((bal, index) =>
        bal.mul(WeiPerEther).div(scalingFactors[index])
    );
}
/////////
/// Fee calculations
...
function _calculateQuadraticTerms(balances, sqrtAlpha, sqrtBeta) {
    const a = WeiPerEther.sub(divDown$1(sqrtAlpha, sqrtBeta));
    ...
    const bSq2 = divDown$1(
        mulDown$1(
            mulDown$1(mulDown$1(balances[0], balances[1]), WeiPerEther.mul(2)),
            sqrtAlpha
        ),
        sqrtBeta
    );
...
function _calcOutGivenIn$1(
    ...
    const virtInOver = balanceIn.add(
        mulUp$1(virtualParamIn, WeiPerEther.add(2))
    );
    const virtOutUnder = balanceOut.add(
        mulDown$1(virtualParamOut, WeiPerEther.sub(1))
    );
    ...
    parsePoolPairData(tokenIn, tokenOut) {
        ...
        const poolPairData = {
            ...
            sqrtAlpha: tokenInIsToken0
                ? this.sqrtAlpha
                : divDown$1(WeiPerEther, this.sqrtBeta),
            sqrtBeta: tokenInIsToken0
                ? this.sqrtBeta
                : divDown$1(WeiPerEther, this.sqrtAlpha),
        };
        return poolPairData;
    }
    getNormalizedLiquidity(poolPairData) {
...
function _makeInitialGuess(input) {
    if (input.gte(WeiPerEther)) {
        return BigNumber$1.from(2)
            .pow(_intLog2Halved(input.div(WeiPerEther)))
            .mul(WeiPerEther);
    } else {
        if (input.lte('10')) {
...
function _safeLargePow3ADown(l, root3Alpha, d) {
    ...
    if (l.lte(_SAFE_LARGE_POW3_THRESHOLD)) {
        ...
        ret = ret
            .mul(l.div(WeiPerEther))
            .add(ret.mul(l.mod(WeiPerEther)).div(WeiPerEther));
        let x = ret;
        for (let i = 0; i < 3; i++) {
            x = x
...
function _calculateCubicStartingPoint(a, mb, mc) {
    ...
    const lmin = divUp(mb, a.mul(3)).add(
        divUp(newtonSqrt(radic, BigNumber$1.from(5)), a.mul(3))
    );
    ...
    const factor = alpha.gte(WeiPerEther.div(2))
        ? WeiPerEther.mul(3).div(2)
        : WeiPerEther.mul(2);
...
function _runNewtonIteration(a, mb, mc, md, root3Alpha, rootEst) {
    ...
    for (let iteration = 0; iteration < 255; ++iteration) {
        ...
        if (
            ...
            deltaAbs.gte(
                deltaAbsPrev.div(
                    BigNumber$1.from(_INVARIANT_SHRINKING_FACTOR_PER_STEP)
                )
            )
        ) {
...
function _calcOutGivenIn(balanceIn, balanceOut, amountIn, virtualOffset) {
    ...
    const virtOutUnder = balanceOut.add(
        mulDown(virtualOffset, WeiPerEther.sub(1))
    );
...
// ///  Spot price function
// /////////
function _calculateNewSpotPrice(
    balances,
    inAmount,
    outAmount,
    virtualOffsetInOut,
...
class Gyro3Pool {
    ...
    static fromPool(pool) {
        ...
        if (
            ...
            parseFixed(pool.root3Alpha, 18).gte(WeiPerEther)
        )
...
const getTokenAddressesForSwap = (swaps) => {
    const tokenAddressesSet = new Set(
        swaps.flatMap((swap) => [swap.tokenIn, swap.tokenOut])
    );
    return [...tokenAddressesSet];
};
/**
    ...
    for (const id in poolsAllDict) {
        ...
        if (pool.poolType == PoolTypes.Linear) {
            ...
            if (config.lbpRaisingTokens) {
                ...
                if (pool.isLBP) {
                    const raisingTokenIn = getRaisingToken(
                        pool,
                        raisingTokens,
                        tokenIn
                    );
                    ...
                    const raisingTokenOut = getRaisingToken(
                        pool,
                        raisingTokens,
                        tokenOut
                    );
...
function getPathsUsingStaBalPool(
    ...
    const hopTokenStaBal =
        (_a = config.staBal3Pool) === null || _a === void 0
            ? void 0
            : _a.address;
...
class SOR {
     ...
     */
    getSwaps(tokenIn, tokenOut, swapType, swapAmount, swapOptions, useBpts) {
        return __awaiter(this, void 0, void 0, function* () {
